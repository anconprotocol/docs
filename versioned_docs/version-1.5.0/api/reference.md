...
```html
https://api.ancon.did.pa/v1/dagjson/baguqeerac33uoqmawkru523zwubchxitrsinqskl7yjr67nqsxtocqv7to7q/?namespace=/
```


####  Read cid without path

```html
https://api.ancon.did.pa/v1/dagjson/baguqeerac33uoqmawkru523zwubchxitrsinqskl7yjr67nqsxtocqv7to7q
```
...
- `wakuaddr`:  Waku Host libp2p address
